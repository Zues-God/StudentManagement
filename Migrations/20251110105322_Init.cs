        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByNavigationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Grade", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Grade_CourseParticipants_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "CourseParticipants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Grade_users_UpdatedByNavigationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grade_ParticipantId",
                table: "Grade",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_Grade_UpdatedByNavigationId",
                table: "Grade",
